...
echo -e "${cor[5]}   generador de payload"
sleep 1.3
echo -e "${cor[1]} $bar ${cor[3]}"
gerar_pay () {
read -p "ingresa tu host: " valor1
[[ -z "$valor1" ]] && err_fun
valor2="127.0.0.1"
echo -e "${cor[1]} $bar ${cor[0]}"
sleep 1.4
echo -e "${cor[5]}    Método de solicitud ${cor[3]}"
echo""
echo -e "          1⃢  GET        2⃢  CONNECT"
echo -e "           3⃢  PUT        4⃢  OPTIONS"
echo -e "          5⃢  DELETE    6⃢  HEAD"
echo -e "              7⃢  TRACE    8⃢  PATCH"
echo -e "${cor[1]} $bar ${cor[3]}"
read -p "    seleccions una opcion [̲̅=̲̅][̲̅>̲̅] " valor3
case $valor3 in
1)req="GET";;
2)req="CONNECT";;
3)req="PUT";;
...
echo -e "${cor[1]} $bar ${cor[0]}"
read -p " escribe tu Proxy: " hostprox
read -p " escribe tu puerto: " portx
echo -e "${cor[1]} $bar ${cor[0]}"
echo -e "${cor[1]} STARTING... ${cor[0]}"
echo -e "${cor[1]} $bar ${cor[0]}"
}
while true; do
echo -e "   [1]-testea un payload"
sleep 1.2
echo -e "   [2]-crea un payload"
echo -e "${cor[1]} $bar ${cor[0]}"
sleep 1
read -p     "elige una opcion[1-2]: " opx
case $opx in
1)
read -p " Digita tu Payload: " payloadx
sleep 1.2
read -p " escribe tu proxi: " hostprox
sleep 1.2
read -p " escribe tu puerto: " portx
echo -e "${cor[1]} $bar ${cor[0]}"
